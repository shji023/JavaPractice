...
@Configuration
public class QuestionConsumerConfig {

    @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrapServers;

    @Bean
    public ConsumerFactory<String, QuestionDTO> stockChangeConsumer() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, QuestionDTO> stockChangeListener() {
